...
- Filter by category - use graphql on archive - done
- redux for multiple sorts on coat page
- Style single pages
- arrow key nav
- Design grid page - done
- Page animation
- Style Nav - mostly done
- Make category pages - done
- Make pet page
...
1. Go to your [project’s API settings on manage.sanity.io](https://manage.sanity.io/projects/93mb4hpw/settings/api) and create a token with read rights.
